...
int main(  int argc, char** argv ) {
  ...
  Mat objectImage; // image of detected object
  namedWindow("Detected Object", CV_WINDOW_NORMAL);
...
//	 cap >> frame;  // get one frame from the camera
     ...
     if (previousMotion <= averageMotion * threshold
        ...
        frame.copyTo(objectImage);
        imshow("Detected Object", objectImage);
